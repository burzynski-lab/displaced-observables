...
\begin{figure}[tb]
  ...
  flagship displacement-weighted observables (colored) and two nominal
...
vertices --- and since an autoencoder models the joint density, signal
...
justify carrying only one of each into the flagship observable set,
