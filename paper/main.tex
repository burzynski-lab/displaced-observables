...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.95\textwidth]{vae_recon_VAE_SpD_truth.png}
  \caption{Per-feature input and reconstruction distributions of the
  VAE trained on QCD only (basis $S{+}D$), for the QCD test sample and
  for signal at $\ctau = 10$~mm. QCD is reconstructed faithfully;
  signal reconstructions are pulled onto the QCD manifold, producing
  the large anomaly score.}
  \label{fig:vaerecon}
\end{figure}
...
% =====================================================================
\section{Comparison with fully supervised classifiers}
