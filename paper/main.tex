...
\section{Input feature distributions}
\label{app:inputs}

Figures~\ref{fig:appS} and~\ref{fig:appD} show every observable used
as an anomaly-detection input (Sec.~\ref{sec:addata}): the 12 nominal
features of basis $S$ and the 12 displacement-weighted features of
basis $D$.
